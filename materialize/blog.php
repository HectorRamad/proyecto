...
<body>
    ...
    <nav class=" black accent-3">
      ...
      <!----------------------------------------------------------------->
       ...
       <div>
        <h2 class="center text-blue">Razones por las que tener una página web profesional</h2>
      </div>
<br><br><br>
    ...
    <div class="col s12 m6">
      <div class="card">
        <div class="card-image">
          ...
          <span class="card-title white-text">Genera credibilidad de negocio</span>
        </div>
    ...
    <div class="col s12 m6">
      <div class="card">
        <div class="card-image">
          ...
          <span class="card-title black-text">Ahorrar dinero a largo plazo</span>
    ...
    <div class="col s12 m6">
      <div class="card">
        <div class="card-image">
          ...
          <span class="card-title black-text">Mejorar el servicio al cliente</span>
